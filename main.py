...
class Main:
    def __init__(self):
        ...
        self.xpathnames = [
            ...
            "Hearts", #me_gustas
            "Comment Hearts", #commentarios
            "Views", #vistas
            "Shares", #compartidos
            "Favorites", #favoritos
            "Livestream"  #lives_tiktok
        ]
        self.discord = ""
        self.option = 0
    ...
    def send(self):
        ...
        try:
            ...
            print(f"\n{Fore.WHITE}[RAMON IA TOK ESTÁ HACIENDO SU TRABAJO]{Fore.RESET}")
        ...
        try:
            ...
            print("[+] Loaded Everything successfully!")
            print(f"\n{Fore.YELLOW}[RAMON IA TOK ESTÁ HACIENDO SU TRABAJO]{Fore.RESET}")
            self.generate_and_send(text_box, search_button, send_button)
        except TimeoutException:
 ...
 ╚═════╝╚═╝  ╚═╝╚═╝     ╚═╝╚═╝╚══════╝ ╚═════╝     
       ...
       ╚══██╔══╝██╔═══██╗██║  ██║
          ...
          ╚═╝    ╚═════╝ ╚═╝  ╚═╝       
             ...
             by @juancamilo actualización 2025 | YOUTUBe

        """ + Fore.RESET)

        self.driver.get("https://zefoy.com/")

        print("[~] iniciando el bot, porfavor!")
        ...
        time.sleep(1)
        self.check_if_website_loaded('row', "[+] servidor iniciado!", "[-] 006 Error - Site cant Connect AND Load", 5)
